        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white border rounded shadow p-4">
              ...
              <div class="p-2">
                ...
                @endif
                <div class="p-2"><a href="{{ route('trainings.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Add New Training</a></div>
                            ...
                            <tr
                              ...
                              <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <form method="post" action="{{ route('trainings.destroy', $training->id) }}">
                                  ...
                                  @csrf
                                  <a href="{{ route('trainings.edit', $training->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Edit</a>
